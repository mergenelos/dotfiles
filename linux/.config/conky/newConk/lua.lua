...
function conky_ring_stats()
	...
	if update_num>5 then
		...
		local fileringcolor = io.popen('python ~/.config/conky/newConk/playRingColor.py')
		...
		for i in pairs(settings_table) do
			...
			if settings_table[i]['name'] == "playRing" then
				...
				-- This will open the file
				local filecompletetime = io.popen('python ~/.config/conky/newConk/completetime.py')
				...
				-- This will open the file
				local fileplayPast = io.popen('python ~/.config/conky/newConk/playPast.py')
				-- This will read all of the output, as always
...
function draw_image()
    ...
    --/home/mak/.config/conky/newConk/mark.png
